...
var AutoFill = function( dt, opts )
{
	...
	this.dom = {
		 ...
		 *   otherwise the mouse over if you bundle into the selected rectangle
...
$.extend( AutoFill.prototype, {
	...
	_getPosition: function ( node, targetParent )
	{
		...
		do {
			...
			// Emergency fall bundle. Shouldn't happen, but just in case!
	...
	_mouseup: function ( e )
	{
		...
		// submit and then we can loop bundle and trigger the fill.
